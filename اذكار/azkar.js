...
function createCard(item) {
  ...
  cardCount.textContent = `التكرار: ${item.count}`;
  ...
  card.addEventListener('click', function() {
      if (item.count > 0) { // التأكد من أن التكرار أكبر من صفر
          item.count--; // إنقاص التكرار
          cardCount.textContent = `التكرار: ${item.count}`; // تحديث العرض
      }
  });
  ...
  // دالة لتحميل الأذكار بناءً على الفئة المختارة
  function loadAzkar(category) {
      azkarList.innerHTML = ''; // تفريغ الأذكار السابقة
      const selectedAzkar = azkar[category] || []; // استرداد الأذكار حسب الفئة
...
// إضافة مستمع للأحداث على روابط التنقل
const navLinks = document.querySelectorAll('nav ul li a');
navLinks.forEach(link => {
    link.addEventListener('click', function(event) {
        event.preventDefault(); // منع السلوك الافتراضي للروابط
        ...
        loadAzkar(category); // تحميل الأذكار للفئة المحددة
    });
});

  // تحميل أذكار الصباح بشكل افتراضي عند تحميل الصفحة
  loadAzkar('morning');
});
